...
gdp_scan_country = pd.read_csv(
    'GDP_data_2015_to_2019_Finland_Norway_Sweden.csv', index_col=0)
...
def plot_gdp_lines(gdp_scan_country, x_col, y_cols, title, x_label, y_label):
    ...
    x_label (str): The plot label for the horizontal-axis.
    y_label (str): The plot label for the vertical-axis.
    
    """
# Plotting a line graph of the GDP of the Scandinavian countries
...
plot_gdp_lines(gdp_scan_country, 'year', list(gdp_scan_country.columns),
               'GDP of Finland Norway & Sweden (2015-2019)', 'Year', 'GDP (in billions of USD)')
...
def plot_gdp_stacked_bar(gdp_scan_country):
    ...
    none
    """
# Plotting a stacked bar chart of the GDP of the Scandinavian countries
...
# This function is used to plot a pie chart of 3 scandinavian countries
